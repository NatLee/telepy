...
from tunnels.views import UpdateAllowedUsernamesView
urlpatterns = [
    ...
    path('share/<int:tunnel_id>/<int:user_id>/allowed-usernames', UpdateAllowedUsernamesView.as_view(), name='update-allowed-usernames'),
]
