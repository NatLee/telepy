    ...
    return (
        <div className="p-6 sm:p-8 text-center">
            ...
            <div className="text-left bg-slate-900 rounded-lg p-6 mb-8 max-w-lg mx-auto">
                <h4 className="text-sm font-medium text-gray-300 mb-1 text-center">{t("wizard.sshConfig")}</h4>
                <p className="text-xs text-gray-400 mb-3 text-center">{tn("wizard.sshConfigBody", { path: <code className="bg-slate-800 px-1 rounded">~/.ssh/config</code> })}</p>
                {configLoading ? (
